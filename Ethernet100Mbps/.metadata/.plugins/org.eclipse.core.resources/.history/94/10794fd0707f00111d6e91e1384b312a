...
bool Eth_Init(void)
{
    ...
    /* 4. Auto-Negotiate (Original 100 Mbps / 10 Mbps logic) */
    ...
    // If auto-negotiation fails to complete, return false
    if (timeout == 0xFFFFF) return false;

    /* 5. Read negotiated Duplex and Speed from PHYSTS (Register 0x10 on DP83848) */
    ...
    // Set Speed: If Bit 1 of PHYSTS is 0, it's 100Mbps. If 1, it's 10Mbps.
    // LPC2478 SUPP Register: Bit 8 = 1 for 100Mbps, 0 for 10Mbps.
