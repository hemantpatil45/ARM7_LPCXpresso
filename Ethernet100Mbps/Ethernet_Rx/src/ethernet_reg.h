...
#define TX_DESC_CTRL_INT       (1UL << 31)  /* Added: Interrupt on TX completion */

/* DMA RX Descriptor Structures (Added for Receiver Demo) */
typedef struct {
    uint32_t Packet;
    uint32_t Control;
} RX_Desc_t;
...
#define RX_DESC_CTRL_INT       (1UL << 31)  /* Generate interrupt on RX completion */

/* RX Status Info word - error bits (LPC2478 UM Table 200) */
...
#define RXSTAT_ERROR           (1UL << 31) /* Silicon reality: Master Error Bit */


#define RXSTAT_CTRL_FRAME      (1UL << 18)
#define RXSTAT_VLAN            (1UL << 19)
#define RXSTAT_FAIL_FILTER     (1UL << 20)
#define RXSTAT_MULTICAST       (1UL << 21)
#define RXSTAT_BROADCAST       (1UL << 22)
#define RXSTAT_CRC_ERROR       (1UL << 23)
#define RXSTAT_SYMBOL_ERROR    (1UL << 24)
#define RXSTAT_LENGTH_ERROR    (1UL << 25)
#define RXSTAT_RANGE_ERROR     (1UL << 26)
#define RXSTAT_ALIGNMENT_ERROR (1UL << 27)
#define RXSTAT_OVERRUN         (1UL << 28)
#define RXSTAT_NO_DESCRIPTOR   (1UL << 29)
#define RXSTAT_LAST_FLAG       (1UL << 30)
