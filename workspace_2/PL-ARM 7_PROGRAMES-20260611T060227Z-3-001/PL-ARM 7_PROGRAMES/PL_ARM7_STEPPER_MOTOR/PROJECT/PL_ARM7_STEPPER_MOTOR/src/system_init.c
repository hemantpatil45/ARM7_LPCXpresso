...
//***********************SET PINSEL FOR SPI PINS ALSO SD CARD***********************
    PINSEL1 &= ~(3UL << 6);//SD_CLOCK P0[19] SET TO 0
    PINSEL1 &= ~(3UL << 8);//M_SPI_SSEL P0[20]  SET TO 0
    PINSEL1 &= ~(3UL << 12);//M_SPI_MISO P0[22] SET TO 0
    PINSEL4 &= ~(3UL << 22);//M_SPI_MOSI P2[11] SET TO 0
    PINSEL2 &= ~(3UL << 22);//M_SPI_MOSI P1[11] SET TO 0
    PINSEL2 &= ~(3UL << 24);//SD_CS P1[12] SET TO 0

//***********************SET PINSEL INTERNAL ADC PIN***********************
    PINSEL1 &=  (1UL << 14);//M_ADC_CH0 P0[23] SET TO 01

//***********************SET INTERNAL DAC PIN***********************
    PINSEL1 &=  (2UL << 20); //M_DAC_OUT P0[26] SET TO 10

//***********************SET PINSEL FOR EXTERNAL ADC PINS***********************
    PINSEL7 &= ~(3UL << 0);//D16/M_ADC_DB0 P3[16] SET TO 0
    PINSEL7 &= ~(3UL << 2);//D16/M_ADC_DB1 P3[17] SET TO 0
    PINSEL7 &= ~(3UL << 4);//D16/M_ADC_DB2 P3[18] SET TO 0
    PINSEL7 &= ~(3UL << 6);//D16/M_ADC_DB3 P3[19] SET TO 0
    PINSEL7 &= ~(3UL << 8);//D16/M_ADC_DB4 P3[20] SET TO 0
    PINSEL7 &= ~(3UL << 10);//D16/M_ADC_DB5 P3[21] SET TO 0
    PINSEL7 &= ~(3UL << 12);//D16/M_ADC_DB6 P3[22] SET TO 0
    PINSEL7 &= ~(3UL << 14);//D16/M_ADC_DB7 P3[23] SET TO 0
    PINSEL7 &= ~(3UL << 16);//D16/M_ADC_DB8 P3[24] SET TO 0
    PINSEL7 &= ~(3UL << 18);//D16/M_ADC_DB9 P3[25] SET TO 0
    PINSEL7 &= ~(3UL << 20);//D16/M_ADC_DB10 P3[26] SET TO 0
    PINSEL7 &= ~(3UL << 22);//D16/M_ADC_DB11 P3[27] SET TO 0
    PINSEL7 &= ~(3UL << 24);//D28/M_ADC_CONVST# P3[28] SET TO 0
    PINSEL7 &= ~(3UL << 26);//D29/M_ADC_CS# P3[29] SET TO 0//DEFAULT OUT SET
    PINSEL7 &= ~(3UL << 28);//D30/M_ADC_RD# P3[30] SET TO 0//DEFAULT OUT SET
    //    PINSEL7 &=  (1UL << 30);//D31/M_ADC_BUSY P3[31] SET TO 01

// ***********************SET PISEL FOR DAC PINS***********************
    PINSEL4 &= ~(3UL << 28);//M_DAC_CS# P2[14] SET TO 0
    PINSEL1 &= ~(3UL << 18);//M_DAC_LD# P0[25] SET TO 0
    PINSEL2 &= ~(3UL << 14);//M_DAC_CLR# P1[7] SET TO 0
...
//*********************** Set PINSEL LED 0 to 3***********************
    PINSEL4 &= ~(3UL << 30);  // P2.15 SET TO 00
    PINSEL5 &= ~(3UL << 6);   // P2.19 SET TO 00
    PINSEL5 &= ~(3UL << 10);  // P2.21 SET TO 00
    PINSEL2 &= ~(3UL << 26);  // P1.13 SET TO 00

//***********************PINSEL for Switch 0 to 3***********************
    PINSEL9 &= ~(3UL << 14);  // Switch 0 P4[23] SET TO 00
    PINSEL9 &= ~(3UL << 20);  // Switch 1 P4[26] SET TO 00
    PINSEL9 &= ~(3UL << 22);  // Switch 2 P4[27] SET TO 00
    PINSEL9 &= ~(3UL << 30);  // Switch 3 P4[31] SET TO 00

//***********************SET PINSEL EXTERNAL INTERRUPT***********************
    PINSEL4 &= ~(3UL << 20);//M_ISP/M_EINT0# P2[10] SET TO 0
