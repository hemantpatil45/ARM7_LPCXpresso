...
//**********************GLCD CONTROL LINES**********************************
//#define   FIO0DIR |= (1 << 4);//M_TFT_R0/LCD_RS P0[4]WORK AS OUTPUT
//#define   FIO0DIR |= (1 << 5);//M_TFT_R1/LCD_RW P0[5] WORK AS OUTPUT
//#define   FIO0DIR |= (1 << 6);//M_TFT_G0/LCD_E P0[6] WORK AS OUTPUT
//#define   FIO0DIR |= (1 << 7);//M_TFT_G1/LCD_DB0 P0[7]WORK AS OUTPUT
//#define   FIO0DIR |= (1 << 8);//M_TFT_B0/LCD_DB1 P0[8] WORK AS OUTPUT
//#define   FIO0DIR |= (1 << 9);//M_TFT_B1/LCD_DB2 P0[9] WORK AS OUTPUT
//#define   FIO1DIR |= (1 << 20);//M_TFT_G2/LCD_DB3 P1[20]WORK AS OUTPUT
//#define   FIO1DIR |= (1 << 21);//M_TFT_G3/LCD_DB4 P1[21] WORK AS OUTPUT
//#define   FIO1DIR |= (1 << 23);//M_TFT_G5/LCD_DB5 P1[23] WORK AS OUTPUT
//#define   FIO1DIR |= (1 << 24);//M_TFT_G6/LCD_DB6 P1[24] WORK AS OUTPUT
//#define   FIO1DIR |= (1 << 25);//M_TFT_G7/LCD_DB7[25] WORK AS OUTPUT
//#define   FIO1DIR |= (1 << 26);//M_TFT_B4/LCD_CS1 P1[26] WORK AS OUTPUT
//#define   FIO0DIR |= (1 << 28);//M_TFT_B6/LCD_CS2 P1[28] WORK AS OUTPUT
//#define   FIO1DIR = (1 << 22); //AS a GPIO for P1[22] ALL Direction = NA(OUT)
...
#define ADC_DATA_IN       ((FIO3PIN >> 16) & 0x0FFF)

#define ADC_CONVST_HIGH()  (FIO3SET = (1u << 28))
#define ADC_CS_HIGH()      (FIO3SET = (1u << 29))
#define ADC_RD_HIGH()      (FIO3SET = (1u << 30))

#define ADC_CONVST_LOW()   (FIO3CLR = (1u << 28))
#define ADC_CS_LOW()       (FIO3CLR = (1u << 29))
#define ADC_RD_LOW()       (FIO3CLR = (1u << 30))

#define ADC_BUSY_IS_HIGH() (FIO3PIN & (1u << 31))
...
#define M_TFT_R4_ON FIO2SET = (1 << 6); //AS a GPIO for P2[6]
