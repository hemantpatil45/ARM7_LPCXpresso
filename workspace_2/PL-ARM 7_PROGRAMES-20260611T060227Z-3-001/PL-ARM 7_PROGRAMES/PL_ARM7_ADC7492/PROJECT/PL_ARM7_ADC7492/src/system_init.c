...
//    SCS |= 0x21;
//    delay_cycles(100);
//    CLKSRCSEL = 0x01; //CLKSRCSEL_bit.CLKSRC = 1; (Clock Source = Main Oscillator)
//
//    PLLCFG |= 0x001000C0; //PLLCFG_bit.MSEL = 192;,  //PLLCFG_bit.NSEL = 16;
//
//    PLLFEED = 0xAA; //PLLFEED_bit.FEED = 0xAA;
//    PLLFEED = 0x55; //PLLFEED_bit.FEED = 0x55;
//
...
//    PINSEL0 |= (1UL << 0); //M_RD1(Can controller ) P0[0] SET TO 01
//    PINSEL0 |= (1UL << 2); //M_TD1(Can controller ) P0[1] SET TO 01
//
...
//    PINSEL3 &= ~(3UL << 24); //M_TFT_B6/LCD_CS2 P1[28] SET TO 01
//    PINSEL3 &= ~(3UL << 26); //M_TFT_B6/LCD_RST P1[29] SET TO 01
//
// //***********************SET PINSEL RELAY_ BUZZER**************************
//    PINSEL0 &= ~(3UL <<20);  // RELAY_BUZZER OUTPUT P0[10] Set to 0 GPIO
//
////***********************PINSEL FOR KEYBOARD********************************
//    PINSEL4 &= ~(3UL << 0);  // KEYBOARD0 P2[0] Set to 0 GPIO
//    PINSEL4 &= ~(3UL << 2);  // KEYBOARD1 P2[1] Set to 0 GPIO
//    PINSEL5 &= ~(3UL << 12); // KEYBOARD2 P2[22] Set to 0 GPIO
//    PINSEL5 &= ~(3UL << 14); // KEYBOARD3 P2[23] Set to 0 GPIO
//    PINSEL5 &= ~(3UL << 18); // KEYBOARD4 P2[25] Set to 0 GPIO
//    PINSEL5 &= ~(3UL << 20); // KEYBOARD5 P2[26] Set to 0 GPIO
//    PINSEL5 &= ~(3UL << 22); // kEYBOARD6 P2[27] Set to 0 GPIO
//    PINSEL0 &= ~(3UL << 22); // KEYBOARD7 P0[11] Set to 0 GPIO
//
...
//    PINSEL4 &= ~(3UL << 28);//M_DAC_CS# P2[14] SET TO 01
//    PINSEL1 &= ~(3UL << 18);//M_DAC_LD# P0[25] SET TO 01
//    PINSEL2 &= ~(3UL << 14);//M_DAC_CLR# P1[7] SET TO 01
//
...
//    PINSEL1 &= ~(3UL << 10);// M_MOTOR_EN_A  P0[21] SET TO 00
//    PINSEL1 &= ~(3UL << 16);// M_MOTOR_EN_B  P0[24] SET TO 00
//    PINSEL2 &= ~(3UL << 4);//M_A_PHASE/M_PWM0[1] P1[2] SET TO 00
//    PINSEL2 &= ~(3UL << 6);//M_B_PHASE/M_PWM0[2] P1[3] SET TO 00
//    PINSEL2 &= ~(3UL << 10);//M_C_PHASE/M_PWM0[3] P1[5] SET TO 00
//    PINSEL2 &= ~(3UL << 12);//M_D_PHASE/M_PWM0[4] P1[6] SET TO 00
//
////*********************** Set PINSEL LED 0 to 3*****************************
//    PINSEL4 &= ~(3UL << 30);  // P2[15] SET TO 0) GPIO
//    PINSEL5 &= ~(3UL << 6);   // P2[19] SET TO 0) GPIO
//    PINSEL5 &= ~(3UL << 10);  // P2[21] SET TO 0) GPIO
//    PINSEL2 &= ~(3UL << 26);  // P1[13] SET TO 0) GPIO
//
////***********************PINSEL for Switch 0 to 3**************************
//    PINSEL9 &= ~(3UL << 14);  // SWITCH 0 P4[23] SET TO 0) GPIO
//    PINSEL9 &= ~(3UL << 20);  // SWITCH 1 P4[26] SET TO 0) GPIO
//    PINSEL9 &= ~(3UL << 22);  // SWITCH 2 P4[27] SET TO 0) GPIO
//    PINSEL9 &= ~(3UL << 30);  // SWITCH 3 P4[31] SET TO 0) GPIO
//
////***********************SET PINSEL EXTERNAL INTERRUPT**********************
//    PINSEL4 |= (1UL << 20);//M_ISP/M_EINT0# P2[10] SET TO 0) GPIO
//
////***********************ETHERNET SECTION***********************************
...
//    PINSEL0 |= ~(3UL << 28);//VBUS P0[14] SET TO 00
...
//   	FIO0DIR = 0X13784FF0; //WRITE VALUE
