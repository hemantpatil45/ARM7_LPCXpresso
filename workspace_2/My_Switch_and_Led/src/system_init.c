...
//
	...
	//set dirrections for Switchs
	FIO4DIR &= ~((1 << 23) | (1 << 26) | (1 << 27) |(1 << 31));// SWITCH WORK IN INPUT DIRRECTION

	// Set directions for LEDs
	FIO2DIR |= (1 << 15) | (1 << 19) | (1 << 21);//LEDs WORK IN OUTPUT DIRRECTION
	FIO1DIR |= (1 << 13);//LEDs WORK IN OUTPUT DIRRECTIO
